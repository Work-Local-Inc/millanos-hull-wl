...
import { Phone, Clock, MapPin, Moon, Star, Truck, ExternalLink, Instagram } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link to="/late-night-service" className="text-red-600 font-medium">Late Night Service</Link>
